...
export const UPGRADE_POOL: Upgrade[] = [
  {
    id: 'num_1_l1',
    name: '1 — The Scout [L1]',
    description: 'Placing a \'1\' permanently clears Fog from its 3x3 box',
    type: 'number',
    number: 1,
    effect: 'scout_clear_box_fog',
    cost: 40,
    rarity: 'common',
  },
  {
    id: 'num_1_l2',
    name: '1 — The Scout [L2]',
    description: 'Placing a \'1\' permanently clears Fog from its entire row and column',
    type: 'number',
    number: 1,
    effect: 'scout_clear_rowcol_fog',
    cost: 120,
    rarity: 'uncommon',
  },
  {
    id: 'num_1_l3',
    name: '1 — The Scout [L3]',
    description: 'Placing a \'1\' permanently removes all Phantom Candidates from its 3x3 box',
    type: 'number',
    number: 1,
    effect: 'scout_remove_phantoms',
    cost: 300,
    rarity: 'rare',
  },
  {
    id: 'num_1_l4',
    name: '1 — The Scout [L4]',
    description: 'Clarity: Placing a \'1\' permanently reveals all Hidden Numbers in its row and column',
    type: 'number',
    number: 1,
    effect: 'scout_clarity',
    cost: 500,
    rarity: 'epic',
  },
  {
    id: 'num_1_l5',
    name: '1 — The Scout [L5]',
    description: 'Total Clarity: Placing a \'1\' triggers all L1-L4 effects simultaneously',
    type: 'number',
    number: 1,
  ...
  },
  {
    ...
    description: 'Omniscience: The first \'1\' you place permanently reveals all \'1\'s on the board. Fog and Phantom events are disabled',
    type: 'number',
    number: 1,
...

  {
    ...
    description: 'Trio: Placing a \'3\' grants +1 Gold for each other \'3\' already placed in its row',
    type: 'number',
    number: 3,
    effect: 'jester_trio',
    cost: 45,
  ...
  },
  {
    ...
    description: 'Trio+: Placing a \'3\' grants +1 Gold for each other \'3\' in its row and column',
    type: 'number',
    number: 3,
  ...
  },
  {
    ...
    description: 'Flow State: (Passive) You are immune to Candidate Shuffling (logic remains stable)',
    type: 'number',
    number: 3,
  ...
  },
  {
    ...
    description: 'Unstoppable: Placing a \'3\' instantly breaks any active Cell Lock on the board',
    type: 'number',
    number: 3,
  ...
  },
  {
    ...
    description: 'Full House: The Trio+ bonus now also counts \'3\'s in its 3x3 box',
    type: 'number',
    number: 3,
  ...
  },
  {
    ...
    description: 'Master of Flow: Immune to all Flow Disruption. Placing a \'3\' triggers a Takedown (solves one Hidden Single)',
    type: 'number',
    number: 3,
...

  {
    ...
    description: '(Passive) Increases your max Mistake Buffer (HP) by +1',
    type: 'number',
    number: 4,
    effect: 'fortress_hp_1',
    cost: 35,
    rarity: 'common',
  },
  {
    ...
    description: 'Shield: Placing a \'4\' grants a Shield. The Shield blocks the penalty (and corruption spread) of your next Mistake, then breaks',
    type: 'number',
    number: 4,
    effect: 'fortress_shield',
    cost: 100,
    rarity: 'uncommon',
  },
  {
    ...
    description: '(Passive) Increases your max Mistake Buffer by +2 (total)',
    type: 'number',
    number: 4,
    effect: 'fortress_hp_2',
    cost: 240,
    rarity: 'rare',
  },
  {
    ...
    description: 'Reinforce: The Shield (L2) now allows for TWO Mistakes before breaking',
    type: 'number',
    number: 4,
    effect: 'fortress_reinforce',
    cost: 400,
    rarity: 'epic',
  },
  {
    ...
    description: '(Passive) Start every new puzzle with a Shield already active',
    type: 'number',
    number: 4,
  ...
  },
  {
    ...
    description: 'Absolution: Once per puzzle, if a Mistake would cause you to lose the run, it is ignored. Your Buffer resets to 1 and all Corruption is Cleansed',
    type: 'number',
    number: 4,
