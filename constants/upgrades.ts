...
export const UPGRADE_POOL: Upgrade[] = [
...

  {
    ...
    description: 'Reinforce: +1 Mistake Buffer (HP)',
    type: 'number',
    number: 4,
  ...
  },
  {
    ...
    description: 'Shield Charge: Grants +1 Shield Charge (max 1). Absorbs next mistake and prevents all corruption',
    type: 'number',
    number: 4,
    effect: 'fortress_shield_charge',
    cost: 100,
    rarity: 'uncommon',
  },
  {
    ...
    description: 'Fortify: +2 Mistake Buffer (total)',
    type: 'number',
    number: 4,
    effect: 'fortress_fortify',
    cost: 240,
    rarity: 'rare',
  },
  {
    ...
    description: 'Armory: Max Shield Charges increases to 2',
    type: 'number',
    number: 4,
    effect: 'fortress_armory',
    cost: 400,
    rarity: 'epic',
  },
  {
    ...
    description: 'Bastion: Start puzzles with 1 Shield Charge. Max Shield Charges increases to 3',
    type: 'number',
    number: 4,
    effect: 'fortress_bastion',
    cost: 600,
    rarity: 'epic',
  },
  {
    ...
    description: 'Absolution: Once per puzzle, resurrect from death with 1 HP and [0/50] Corruption',
    type: 'number',
    number: 4,
