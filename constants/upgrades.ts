...
export const UPGRADE_POOL: Upgrade[] = [
  {
    id: 'num_1_l1',
    name: '1 — The Scout [L1]',
    description: 'Clears Fog from its 3x3 box',
    type: 'number',
    number: 1,
  ...
  },
  {
    id: 'num_1_l2',
    name: '1 — The Scout [L2]',
    description: 'Clears Fog from its row and column',
    type: 'number',
    number: 1,
  ...
  },
  {
    id: 'num_1_l3',
    name: '1 — The Scout [L3]',
    description: 'Removes all Phantom Candidates from its 3x3 box',
    type: 'number',
    number: 1,
  ...
  },
  {
    id: 'num_1_l4',
    name: '1 — The Scout [L4]',
    description: 'Reveals Hidden Numbers in its row and column for 10 seconds',
    type: 'number',
    number: 1,
  ...
  },
  {
    id: 'num_1_l5',
    name: '1 — The Scout [L5]',
    description: 'Total Clarity: Performs all L1-L4 effects simultaneously',
    type: 'number',
    number: 1,
  ...
  },
  {
    ...
    description: 'Omniscience: First \'1\' placed reveals all \'1\'s. Disables Fog/Phantom events',
    type: 'number',
    number: 1,
...

  {
    ...
    description: 'Trio: Grants +1 Gold for each other \'3\' in its row',
    type: 'number',
    number: 3,
    effect: 'jester_trio',
    cost: 45,
  },
  {
    ...
    description: 'Trio+: Grants +1 Gold for each other \'3\' in its row and column',
    type: 'number',
    number: 3,
  ...
  },
  {
    ...
    description: 'Flow State: Immune to Input Delays and Candidate Shuffling',
    type: 'number',
    number: 3,
  ...
  },
  {
    ...
    description: 'Full House: Trio+ bonus now also includes its 3x3 box',
    type: 'number',
    number: 3,
  ...
  },
  {
    ...
    description: 'Master of Flow: Immune to all Flow Disruption. Placing a \'3\' also solves one random Hidden Single',
    type: 'number',
    number: 3,
